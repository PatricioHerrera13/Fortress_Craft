...
public class EntregaCañon : MonoBehaviour
{
    public List<ItemNecesario> itemsRequeridos; // Lista de objetos requeridos
    public DeteccionDisparo deteccion; // Referencia al script Torreta
    public EntregaCañon detector;
    ...
    private void Update()
    {
        if (canDeliver && Input.GetKeyDown(KeyCode.X)) // Cambia la tecla según lo necesites
        {
